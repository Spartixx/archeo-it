...
<div class="flex flex-col gap-[7rem] justify-between p-5">
    ...
    <div class="w-full h-fit flex flex-col justify-start items-center gap-10 h-100 rounded-xl border-1">
        <div class="w-full flex flex-col gap-5 justify-start items-center border-xl">

            <form method="post" class="w-full h-20 rounded-xl flex flex-row justify-between">

                <button name="BlogSelection" class="flex flex-row items-center justify-center rounded-b-3xl rounded-tr-[0] rounded-tl-xl border-1 border-t-0 sm:text-sm md:text-lg p-2 w-full bg-yellow-950/40 text-black transition hover:bg-yellow-950 hover:text-white">
                ...
                <button name="SiteSelection" type="submit" class="flex flex-row items-center justify-center rounded-b-3xl rounded-tl-[0] rounded-tr-xl  border-1 border-t-0 border-x-0 border-r-0 sm:text-sm md:text-lg p-2 w-full bg-yellow-950/40 text-black transition hover:bg-yellow-950 hover:text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="mr-2 h-5 w-5">
